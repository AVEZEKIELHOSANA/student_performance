...
const menuItems: MenuItem[] = [
  { id: 'overview', label: 'Overview', icon: FaTachometerAlt, href: '/admin' },
  { id: 'users', label: 'Users', icon: FaUsers, href: '/admin/users' },
  { id: 'assignments', label: 'Assignments', icon: FaLink, href: '/admin/assignments' },
  { id: 'instructors', label: 'Instructors', icon: FaChalkboardTeacher, href: '/admin/instructors' },
  {
    id: 'settings',
    label: 'Settings',
    icon: FaCog,
    href: '/admin/settings',
    subItems: [
      { id: 'profile', label: 'Profile', icon: FaUserShield, href: '/admin/settings/profile' },
    ],
  },
];
                        ...
                        return (
                          <Link
                            ...
                            className={`
                              ...
                              ${isSubActive ? 'bg-white/20 text-white font-medium' : 'text-white/60 hover:bg-white/10 hover:text-white'}
                            `}
                          >
                            <SubIcon size={14} />
